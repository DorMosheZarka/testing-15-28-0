import styles from './donation-card.module.css';
    ...
    return (
        <article className={styles.donationCard} onClick={onShowMore}>
            <header className={styles.header}>
                ...
                <button className={getButtonClassNames(progress)} onClick={onShowModal}>
                    Donate Now
                </button>
            </header>
            {isOpen && <section className={styles.description}>{description}</section>}
            <footer>
                <section className={styles.targetInfo}>
                    ...
                    <p className={styles.target}>${donationTarget.toLocaleString()}</p>
                </section>
